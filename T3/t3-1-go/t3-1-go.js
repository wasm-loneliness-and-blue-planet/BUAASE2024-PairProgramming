...
// This file has been modified for use of BUAASE2024-Pair-Programming.
...
const wasmBuffer = fs.readFileSync("./t3-1-go/main.wasm");
const go = new Go();
const module = await WebAssembly.instantiate(wasmBuffer, go.importObject);
go.run(module.instance);
export const /** @type {(flag: number, seq: number[], size: number) => number} */ mancalaBoard =
    globalThis.mancalaBoard;
